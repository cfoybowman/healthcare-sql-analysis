-- =========================================================
-- File: 06_transform_load_fact.sql
-- Project: Healthcare Provider Services SQL Analysis
-- Author: Christina Foy-Bowman
-- Purpose: Populate dim_date and fact_weekly_hospitalization from staging.
-- Notes: Removes commas, trims text, converts blanks to NULL.
-- =========================================================
